                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="item-tabcard-img">
                                                    <div class="item-tabcard-imgs"> <a aria-label="anchor" href="{{ route('category.real.estate.detail', ['category' => strtolower($category->name),'id' => $item->id, 'slug' => $item->slug]) }}"></a> <img src="{{ url($item->images->first()->image_url) }}" alt="img" class="cover-image rounded-1 w-100"> </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        <div class="card">
                                            <div class="card-body position-relative p-3">
                                                <div class="position-relative mb-3 overflow-hidden"> <a aria-label="anchor" href="{{ route('category.real.estate.detail', ['category' => strtolower($category->name),'id' => $item->id, 'slug' => $item->slug]) }}"></a> <img src="{{ url($item->images->first()->image_url) }}" alt="img" class="cover-image w-100 h-100 rounded-1"> <span class="badge bg-secondary blog-badge text-primary">New</span> <span class="badge bg-pink blog-badge2">₹{{ number_format($item->price, 2), ',' }}</span> <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-title="Add to Wishlist" data-bs-placement="top" class="badge bg-black-2 blog-badge3"><i class="fa-regular fa-heart"></i></a> </div>
