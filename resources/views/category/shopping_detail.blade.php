        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="position-sticky top-0 mt-3 mt-lg-0">
                    <div class="card">
                        ...
                        <div class="card-body item-user">
                            ...
                            <div>
                                ...
                                <p class="mb-3"><span><i class="fe fe-mail me-2 d-inline-block"></i></span><a href="javascript:void(0);" class="text-default"> {{ $ad->email }}</a></p>
                                ...
                                <p class="mb-0"><span><i class="fe fe-link me-2 d-inline-block"></i></span><a href="{{ $ad->website }}" class="text-default" target="_blank">{{ $ad->website }}</a></p>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Search Business</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                <select class="form-control" data-trigger>
                                    @forelse($extras->where('name', 'category') as $key => $ex)
