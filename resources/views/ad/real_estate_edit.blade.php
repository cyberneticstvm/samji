...
<section class="section bg-white">
    <div class="container">
        <div class="heading-section">
            <div class="heading-title">Update your <span class="text-primary">Ad</span></div>
        </div>
        {{ html()->form('POST', route('post.ad.real.estate.update', $ad->id))->class('row justify-content-center align-items-center needs-validation')->attribute('id', 'myForm')->acceptsFiles()->open() }}
                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                {{ html()->text('title', $ad->title)->class("form-control ms-0")->maxlength('150')->placeholder("Ad Title") }}
                                @error('title')
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                {{ html()->textarea('description', $ad->description)->class("form-control ms-0")->rows('5')->placeholder("Ad Description") }}
                                @error('description')
                            ...
                            <div class="col-xl-6 mb-3">
                                ...
                                {{ html()->select('type', $extras->where('name', 'type')->pluck('value', 'id'), $ad->type)->class("form-control ms-0 select2")->placeholder("Select") }}
                                @error('type')
                            ...
                            <div class="col-xl-6 mb-3">
                                ...
                                <div class="d-md-flex">
                                    ...
                                    <div class="form-check me-4">
                                        {{ html()->radio('category')->class('form-check-input')->attribute('id', 'flexRadioDefault_'.$item->id)->attribute('value', $item->id)->if($ad->category == $item->id, function($el){
                                            return $el->attribute('checked', true);
                                        }) }}
                            ...
                            <div class="col-xl-2 mb-3">
                                ...
                                {{ html()->number('number_of_beds', $ad->number_of_beds)->class("form-control ms-0")->placeholder("0") }}
                            </div>
                            <div class="col-xl-2 mb-3">
                                <label class="mb-2 form-label">No. of Baths</label>
                                {{ html()->number('number_of_baths', $ad->number_of_baths)->class("form-control ms-0")->placeholder("0") }}
                            </div>
                            <div class="col-xl-4 mb-3">
                                <label class="mb-2 form-label">No. of Washrooms </label><span class="text-primary small">(Applicable for Shop & Offices)</span>
                                {{ html()->number('number_of_washrooms', $ad->number_of_washrooms)->class("form-control ms-0")->placeholder("0") }}
                            </div>
                            <div class="col-xl-2 mb-3">
                                <label class="mb-2 form-label">Furnished</label>
                                {{ html()->select('furnished', $extras->where('name', 'furnish')->pluck('value', 'id'), $ad->furnished)->class("form-control ms-0 select2")->placeholder("Select") }}
                            </div>
                            <div class="col-xl-2 mb-3">
                                <label class="mb-2 form-label">Buildup Area (Sqft)</label>
                                {{ html()->number('buildup_area', $ad->buildup_area)->class("form-control ms-0")->placeholder("0") }}
                            </div>
                            <div class="col-xl-2 mb-3">
                                <label class="mb-2 form-label">Carpet Area (Sqft)</label>
                                {{ html()->number('carpet_area', $ad->carpet_area)->class("form-control ms-0")->placeholder("0") }}
                            </div>
                            <div class="col-xl-2 mb-3">
                                <label class="mb-2 form-label">Number of Floors</label>
                                {{ html()->number('number_of_floors', $ad->number_of_floors)->class("form-control ms-0")->placeholder("0") }}
                            </div>
                            <div class="col-xl-2 mb-3">
                                <label class="mb-2 form-label">Number of Car Parkings</label>
                                {{ html()->number('number_of_parkings', $ad->number_of_parkings)->class("form-control ms-0")->placeholder("0") }}
                            </div>
                            <div class="col-xl-2 mb-3">
                                <label class="mb-2 form-label">Facing</label>
                                {{ html()->select('facing', $extras->where('name', 'facing')->pluck('value', 'id'), $ad->facing)->class("form-control ms-0 select2")->placeholder("Select") }}
                            </div>
                            <div class="col-xl-4 mb-3">
                                <label class="mb-2 form-label">Project Name</label>
                                {{ html()->text('project_name', $ad->project_name)->class("form-control ms-0")->placeholder("Project Name") }}
                            </div>
                            <div class="col-xl-2 mb-3">
                            ...
                            <div class="row mt-3 mb-3">
                                ...
                                <div class="col-xl-2 mb-3">
                                    ...
                                    {{ html()->number('plot_area', $ad->plot_area)->class("form-control ms-0")->placeholder("0") }}
                                </div>
                                <div class="col-xl-2 mb-3">
                                    <label class="mb-2 form-label">Length</label>
                                    {{ html()->number('length', $ad->length)->class("form-control ms-0")->placeholder("0") }}
                                </div>
                                <div class="col-xl-2 mb-3">
                                    <label class="mb-2 form-label">Breadth</label>
                                    {{ html()->number('breadth', $ad->breadth)->class("form-control ms-0")->placeholder("0") }}
                                </div>
                            </div>
                            <div class="col-sm-12 mb-3">
