...
<section class="section bg-white">
    <div class="container">
        <div class="heading-section">
            <div class="heading-title">Update <span class="text-primary">Business Details</span></div>
        </div>
        {{ html()->form('POST', route('post.ad.shopping.update', $ad->id))->class('row justify-content-center align-items-center needs-validation')->attribute('id', 'myForm')->acceptsFiles()->open() }}
                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-sm-5 mb-3">
                                ...
                                {{ html()->text('name', $ad->title)->class("form-control ms-0")->maxlength('100')->placeholder("Business Name") }}
                                @error('name')
                            ...
                            <div class="col-sm-3 mb-3">
                                ...
                                {{ html()->select('category', $extras->where('name', 'category')->pluck('value', 'id'), $ad->category)->class("form-control ms-0 select2")->placeholder("Select") }}
                                @error('category')
                            ...
                            <div class="col-sm-3 mb-3">
                                ...
                                {{ html()->email('email', $ad->email)->class("form-control ms-0")->placeholder("Email") }}
                                @error('email')
                            ...
                            <div class="col-xl-3 mb-3">
                                ...
                                {{ html()->text('website', $ad->website)->class("form-control ms-0")->maxlength(50)->placeholder("www.example.com") }}
                                @error('website')
                            ...
                            <div class="col-xl-12 mb-3">
                                ...
                                {{ html()->textarea('description', $ad->description)->class("form-control ms-0")->maxlength(50)->placeholder("Description") }}
                                @error('description')
