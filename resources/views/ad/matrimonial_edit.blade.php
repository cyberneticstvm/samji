                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-sm-2 mb-3">
                                ...
                                {{ html()->select('religion', $casts->where('type', 'religion')->pluck('name', 'id'), $ad->religion)->class("form-control ms-0 select2")->placeholder("Select") }}
                                @error('religion')
                            ...
                            <div class="col-sm-2 mb-3">
                                ...
                                {{ html()->select('caste', $casts->where('type', 'caste')->pluck('name', 'id'), $ad->caste)->class("form-control ms-0 select2")->placeholder("Select") }}
                                @error('caste')
                            ...
                            <div class="col-sm-2 mb-3">
                                ...
                                {{ html()->select('subcaste', $casts->where('type', 'subcaste')->pluck('name', 'id'), $ad->subcaste)->class("form-control ms-0 select2")->placeholder("Select") }}
                                @error('subcaste')
                            ...
                            <div class="col-xl-2 mb-3">
                                ...
                                {{ html()->text('pincode', $ad->pincode)->class("form-control ms-0")->maxlength(6)->placeholder("xxxxxx") }}
                                @error('pincode')
