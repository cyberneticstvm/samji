...
firstLevelItems.forEach((element) => {
  element.addEventListener("click", () => {
    let html = document.querySelector("html");
    console.log('html.getAttribute("data-nav-style") != "menu-hover"',html.getAttribute("data-nav-style") != "menu-hover",
      'html.getAttribute("data-nav-style") != "icon-hover"',html.getAttribute("data-nav-style") != "icon-hover",
      "window.innerWidth < 992",window.innerWidth < 992,
      '!html.getAttribute("data-toggled")',!html.getAttribute("data-toggled"),
      'html.getAttribute("data-nav-layout") != "horizontal"',html.getAttribute("data-nav-layout") != "horizontal"
    );
    if ( html.getAttribute("data-nav-style") != "icon-hover" || (!html.getAttribute("data-toggled") && html.getAttribute("data-nav-layout") != "horizontal")) {
...
innerLevelItems.forEach((element) => {
  ...
  element.addEventListener("click", () => {
    ...
    if ( html.getAttribute("data-nav-style") != "icon-hover" || window.innerWidth < 992 || (!html.getAttribute("data-toggled") && html.getAttribute("data-nav-layout") != "horizontal")) {
...
(() => {
  ...
  if (
    !localStorage.getItem("roxlistlayout") &&
    !localStorage.getItem("roxlistnavstyles") &&
    !localStorage.getItem("roxlistverticalstyles") &&
      ...
      switch (verticalStyle) {
        ...
        case "overlay":
          ...
          if (html.getAttribute("data-toggled") === "icon-overlay-close") {
            ...
            if (window.innerWidth >= 992) {
              if (!localStorage.getItem("roxlistlayout")) {
...
function doubletFn() {
  ...
  //     if (window.innerWidth >= 992) {
  //       if (localStorage.roxlistverticalstyles == "doublemenu") {
...
setTimeout(() => {
if(document.querySelector(".slide.has-sub.active.open .child1 >.open ul")){
  document.querySelector(".slide.has-sub.active.open .child1 >.open ul").style.display = "block"
}
}, 100);
